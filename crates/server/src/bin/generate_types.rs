...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::workflow_scheme::WorkflowTransition::decl(),
        db::models::workflow_scheme::TransitionAction::decl(),
        db::models::workflow_scheme::CreateWorkflowScheme::decl(),
        db::models::workflow_scheme::UpdateWorkflowScheme::decl(),
        server::routes::workflow_schemes::CloneSchemeRequest::decl(),
        server::routes::workflow_schemes::ValidationResult::decl(),
